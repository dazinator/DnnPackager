...
namespace DnnPackager.Command
{
    ...
    public class BuildProjectOptions : CommonOptions
    {
        ...
        [Option('e', "envdteversion", Required = false, HelpText = "The version of envdte for the running visual studio instance.")]
